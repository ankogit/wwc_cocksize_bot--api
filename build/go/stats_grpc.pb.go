...
type StatsClient interface {
	Get(ctx context.Context, in *SearchReq, opts ...grpc.CallOption) (*GetStatsResp, error)
}
...
func (c *statsClient) Get(ctx context.Context, in *SearchReq, opts ...grpc.CallOption) (*GetStatsResp, error) {
	out := new(GetStatsResp)
	err := c.cc.Invoke(ctx, "/api.Stats/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatsServer interface {
	Get(context.Context, *SearchReq) (*GetStatsResp, error)
...
func (UnimplementedStatsServer) Get(context.Context, *SearchReq) (*GetStatsResp, error) {
...
func _Stats_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Stats/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatsServer).Get(ctx, req.(*SearchReq))
	}
